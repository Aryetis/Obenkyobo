...
private :
    ...
    {
public :
        SymbolsTableFamily(std::vector<SymbolsTableSection> _data)
            : data(_data)
        {}
...
private :
    ...
    //========================================== HIRAGANA ==========================================
    static SymbolsTableFamily HiraganaSymbolsTableFamily
    (
    ...
    //========================================== KATAKANA ==========================================
    static SymbolsTableFamily KatakanaSymbolsTableFamily
    (
        std::vector<SymbolsTableSection>
        {
            SymbolsTableSection
