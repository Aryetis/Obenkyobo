...
// TODO now handle disable / enable set => handle edge cases like "not enough data to initialize entriesGridLayout", etc
//class  Symbol
//{
//public :
//    Symbol() = default;
...
//            (b) ? parentedFamily->NbrOfElement++ : parentedFamily->NbrOfElement--
//        }
//    }
