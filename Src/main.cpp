...
int main(int argc, char *argv[])
{
    ...
    (
        ...
        "QScrollBar::add-line                                                                                       "
        "{ border: none; background: white; height: 100px; subcontrol-position: bottom; subcontrol-origin: margin; }"
        "QScrollBar::sub-line                                                                                       "
        "{ border: none; background: white; height: 100px; subcontrol-position: top; subcontrol-origin: margin; }   "
        ...
        "	border: none; width: 80px; height: 80px; background: none;                                              "
        "}                                                                                                          "
